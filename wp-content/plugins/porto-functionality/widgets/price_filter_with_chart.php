...
// Delete 'porto_price_chart' transient
add_action( 'load-woocommerce_page_wc-status', 'porto_delete_chart_transient' );
function porto_delete_chart_transient() {
	delete_site_transient( 'porto_price_chart' );
}

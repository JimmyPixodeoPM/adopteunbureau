...
class Porto_Functionality {
	...
	private $woo_widgets = array( 'price_filter_list', 'price_filter_with_chart' );
	...
	public function __construct() {
		...
		// add libraries
		require_once PORTO_FUNC_LIB_PATH . 'cache/class-cache.php';
		...
		// without theme
		add_action( 'after_setup_theme', array( $this, 'define_theme_variables' ) );
	}
	...
	public function load() {
		...
		// Restore the legacy widget
		add_filter( 'widget_types_to_hide_from_legacy_widget_block','__return_empty_array', 100 );
		// add metaboxes
	...
	protected function define_constants( $active_plugins ) {
		...
		define( 'PORTO_FUNC_VERSION', '3.2.10' );
	...
	public function load_woo() {
		if ( class_exists( 'WooCommerce' ) ) {
			...
			// include porto compare product
			require_once PORTO_FUNC_LIB_PATH . 'compare-product/class-compare-product.php';
		}
	}
	 ...
	 * @since 7.1.5
	 */
	public function define_theme_variables() {
		if ( ! defined( 'PORTO_OPTIONS_URI' ) ) {
			define( 'PORTO_OPTIONS_URI', 'https://sw-themes.com/porto_dummy/wp-content/themes/porto/inc/admin/theme_options' );
		}
	}
}

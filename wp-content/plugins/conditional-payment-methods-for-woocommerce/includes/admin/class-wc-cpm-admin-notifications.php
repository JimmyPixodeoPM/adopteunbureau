	...
	class WC_CPM_Admin_Notifications {
		...
		public function plugin_action_links( $links = array() ) {
			...
			$action_links = array(
				...
				'docs'     => '<a href="' . esc_url( 'https://woocommerce.com/document/conditional-payment-methods-for-woocommerce/' ) . '" title="' . esc_attr( __( 'Documentation', 'conditional-payment-methods-for-woocommerce' ) ) . '" target="_blank">' . esc_html( __( 'Docs', 'conditional-payment-methods-for-woocommerce' ) ) . '</a>',
				'faqs'     => '<a href="' . esc_url( 'https://woocommerce.com/document/conditional-payment-methods-for-woocommerce/#section-7' ) . '" title="' . esc_attr( __( 'FAQ', 'conditional-payment-methods-for-woocommerce' ) ) . '" target="_blank">' . esc_html( __( 'FAQ', 'conditional-payment-methods-for-woocommerce' ) ) . '</a>',
				...
				'review'   => '<a href="' . esc_url( 'https://woocommerce.com/products/conditional-payment-methods-for-woocommerce/#reviews' ) . '" title=" ' . esc_attr( __( 'Leave a review', 'conditional-payment-methods-for-woocommerce' ) ) . '" target="_blank">' . __( 'Review', 'conditional-payment-methods-for-woocommerce' ) . '</a>',
			);

...
if ( ! function_exists( 'porto_woocommerce_product_sticky_addcart' ) ) :
	...
	function porto_woocommerce_product_sticky_addcart( $el_class = '' ) {
		...
		echo '<div class="aaa sticky-product hide pos-' . esc_attr( $porto_settings['product-sticky-addcart'] ) . ( $el_class ? ' ' . esc_attr( $el_class ) : '' ) . '"><div class="container">';
			...
			echo '</div>';
			echo '<div class="add-to-cart aaaa">';

...
<div class="cart_totals<?php echo WC()->customer->has_calculated_shipping() ? ' calculated_shipping' : ''; ?>">
	<div class="cart_totals_toggle">
		<div class="card card-default">
			<h4 class="card-sub-title text-md text-uppercase mb-0 pb-2"><?php esc_html_e( 'Cart totals', 'woocommerce' ); ?></h4>
			<p class="m-b-md sub-title-new">Payez cet article en 3 fois.s</p>

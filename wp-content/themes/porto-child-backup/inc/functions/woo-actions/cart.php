...
function porto_add_to_cart_message_html( $message, $products, $show_qty ) {
	...
	/* translators: %s: product name */
	$added_text = sprintf( _n( '<strong class="single-cart-notice">%s</strong> <span class="font-weight-medium">a été ajouté à votre panier.</span>', '<strong class="single-cart-notice">%s</strong> <span class="font-weight-medium">have been added to your cart.</span>', $count, 'porto' ), wc_format_list_of_items( $titles ) );
			...
			<div class="success-message-container d-none">
				<div class="msg-box">
					<div class="msg">
						...
						<?php printf( esc_html__( '%s a été ajouté à votre panier.', 'porto' ), '<div class="product-name"></div>' ); ?>
					</div>
				</div>

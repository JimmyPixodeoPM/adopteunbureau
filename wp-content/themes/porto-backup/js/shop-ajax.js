...
( function( theme, $ ) {
    ...
    var categoryAjaxProcess = function( href, updateSelect2, updateStyle, isCategoryFilter = false ) {
        ...
        if ( $( '.elementor-widget-wc-archive-products' ).length ) {
            _prefix = '.elementor-widget-wc-';
        }
        var shop_before = '.shop-loop-before',
            $shop_before = $( shop_before ),
            shop_after = '.shop-loop-after:not(.is-shortcode)',
            shop_container = _prefix + 'archive-products .products:not(.is-shortcode)',
            shop_info = _prefix + 'archive-products .woocommerce-info',
    ...
    var categoryAjax = function() {
        ...
        if ( theme.category_ajax ) {
            ...
            $( '.widget_layered_nav, .widget_rating_filter, .widget_layered_nav_filters' ).off( 'click', 'a' ).on( 'click', 'a', function( e ) {
                ...
                if ( $this.hasClass( 'yith-wcan-reset-navigation' ) && !$( _prefix + 'archive-products .products:not(.is-shortcode)' ).length ) {
    ...
    var ajaxFiltered = function( initLoad ) {
        ...
        var shop_before = '.shop-loop-before',
            ...
            shop_container = _prefix + 'archive-products .products',
        ...
        } else if ( $( shop_container ).find( '.product' ).length || $( shop_after ).closest( '.porto-products' ).length || $shop_before.hasClass( 'shop-builder' ) || $( shop_after ).closest( '.elementor-widget-wc-archive-products' ) ) {
    ...
    $( function() {
        ...
        if ( typeof yith_wcan != 'undefined' ) {
            yith_wcan.container = _prefix + 'archive-products .products';
        ...
        $( document ).on( 'yith-wcan-ajax-filtered', function( e, res ) {
            ...
            if ( res && typeof porto_infinite_scroll !== 'undefined' ) {
                ...
                var shop_container = _prefix + 'archive-products .products:not(.is-shortcode)',
                    $shop_container = $( shop_container );
                if ( $shop_container.length ) {
                    var $parent = $shop_container.parent();
                    if ( $parent.hasClass( 'porto-posts-grid' ) ) {
        ...
        $( document ).on( 'click', '.gridlist-toggle #grid, .gridlist-toggle #list', function( e ) {
            ...
            if ( theme.category_ajax ) {
                ...
                if ( js_porto_vars.use_skeleton_screen.indexOf( 'shop' ) != -1 ) {
                    $( _prefix + 'archive-products ul.products, .archive-products .products-container' ).removeClass( 'grid' ).removeClass( 'list' ).addClass( viewMode );
                } else {
                    $( _prefix + 'archive-products' ).addClass( 'porto-ajax-loading' );
                }
